<nav class="flex flex-wrap items-center justify-between bg-white p-[20px_30px] rounded-[20px] gap-y-3">
    <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
          <p id="CompanyName" class="font-extrabold text-xl leading-[30px]">Raihan Travels</p>
    ...
    <ul class="flex flex-wrap items-center gap-[30px]">
        ...
        <li class="{{ request()->routeIs('front.about') ? 'text-cp-dark-blue' : '' }} font-semibold hover:text-cp-dark-blue transition-all duration-300">
            <a href="{{ route('front.about') }}">Company</a>
        </li>
        <li class="{{ request()->routeIs('front.partnership') ? 'text-cp-dark-blue' : '' }} font-semibold hover:text-cp-dark-blue transition-all duration-300">
            <a href="{{ route('front.partnership') }}">Partnership</a>
        </li>
    </ul>
